                      ...
                      <tbody className="divide-y divide-slate-100">
                        {(form.items || []).map((item, idx) => (
                          <tr key={idx}>
                            ...
                            <td className="p-3 text-right font-mono text-slate-600">${parseFloat(item.unitPrice || 0).toLocaleString()}</td>
                            <td className="p-3 text-center text-slate-700">{item.quantity} {item.measureUnit}</td>
                            <td className="p-3 text-right font-bold text-slate-900">${parseFloat(item.subtotal || 0).toLocaleString()}</td>
                          </tr>
                        ))}
                        <tr className="bg-slate-50/50 font-bold border-t border-slate-200">
                            ...
                            <td className="p-3 text-right text-blue-700 text-xl">${parseFloat(form.totalPrice || 0).toLocaleString()}</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
